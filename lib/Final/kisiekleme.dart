...
class kisiekleme extends StatelessWidget {
  final Contact contact;

  const kisiekleme({Key key, @required this.contact}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        Stack(children: [
          Image.asset(
            contact.avatar == null ? "assets/images/person.jpg" : contact.avatar,
            fit: BoxFit.cover,
